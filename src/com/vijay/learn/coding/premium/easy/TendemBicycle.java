...
public class TendemBicycle {
  ...
  public static void main(String[] args) {
    ...
    TendemBicycle tendemBicycle = new TendemBicycle();
    tendemBicycle.tandemBicycle(redShirtSpeeds, blueShirtSpeeds, fastest);
  }
}

/*
Difficulty: Category: HiddenSuccessful Submissions: 20,064+Tandem Bicycle
...
Optimal Space & Time ComplexityO(nlog(n)) time | O(1) space - where n is the number of tandem bicycles
 */
